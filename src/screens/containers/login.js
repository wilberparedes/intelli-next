                ...
                <ImageBackground source={require('../../../assets/image-home-login.png')} style={styles.imageBackground} >
                    ...
                    <View style={styles.container}>
                        ...
                        <Button
                                title="Registrarse"
                                titleStyle={StylesGeneral.fontPrimaryButton}
                                buttonStyle={StylesGeneral.buttonWhite}
                                containerStyle={[{ width: '100%' }, StylesGeneral.marginvertical]}
                                onPress={this.registerHandlePress}
                                />

                        <TouchableHighlight style={styles.contentText} onPress={this.ForgotPasswordHandlePress}>
                            <Text style={[styles.textWhite, StylesGeneral.marginvertical]}>¿Has olvidado tu contraseña?</Text>
                        </TouchableHighlight>
...
function mapStateToProps(state){
    return{
        ...
        detailsLocality: state.location.dataDetailsLocality
    }
}
